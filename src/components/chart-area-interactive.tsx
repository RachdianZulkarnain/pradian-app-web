...
export function ChartAreaInteractive() {
  ...
  return (
    <Card className="@container/card border-4 border-gray-900 bg-white shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between sm:gap-0">
          ...
          <CardAction>
            <Select value={selectedYear} onValueChange={setSelectedYear}>
              <SelectTrigger className="h-10 w-32 rounded-none border-2 border-gray-900 bg-white text-sm font-bold text-gray-900 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:bg-gray-100">
      ...
      <CardContent className="px-4 pt-4 pb-6 sm:px-6 sm:pt-6">
        <ChartContainer
          config={chartConfig}
